...
class TestCoverageEndpoint:
    ...
    def test_create_coverage_metric(self, component_client: TestClient):
        ...
        response = component_client.post("/api/v1/coverage", json=payload)
    ...
    def test_create_coverage_partial_data(self, component_client: TestClient):
    ...
    def test_create_coverage_minimal_data(self, component_client: TestClient):
    ...
    def test_create_coverage_invalid_data(self, component_client: TestClient):
